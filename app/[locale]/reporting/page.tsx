    ...
    <div className="min-h-screen py-4 sm:py-6 lg:py-8">
      <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-6 xl:px-8">
        ...
        <div className="space-y-6 sm:space-y-8">
          ...
          <section className="bg-white dark:bg-slate-800 shadow-lg rounded-lg overflow-hidden">
            <div className="bg-gradient-to-r from-green-600 to-green-700 px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
              <h2 className="text-lg sm:text-xl lg:text-2xl font-bold text-white flex items-center">
                ...
                <span className="truncate">{isEnglish ? 'Step 1: Service Request' : 'ধাপ ১: সেবা অনুরোধ'}</span>
              </h2>
            </div>
          ...
          <section className="bg-white dark:bg-slate-800 shadow-lg rounded-lg overflow-hidden">
            <div className="bg-gradient-to-r from-blue-600 to-blue-700 px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
              <h2 className="text-lg sm:text-xl lg:text-2xl font-bold text-white flex items-center">
                ...
                <span className="truncate">{isEnglish ? 'Step 2: Processing & Review' : 'ধাপ ২: প্রক্রিয়াকরণ ও পর্যালোচনা'}</span>
              </h2>
            </div>
            <div className="p-4 sm:p-6 lg:p-8">
                  ...
                  <div>
                    ...
                    <ul className="space-y-2 text-gray-600 dark:text-gray-300">
                      <li className="flex items-start">
                        ...
                        <span className="text-xs sm:text-sm break-words">{isEnglish ? 'Document verification and completeness check' : 'নথি যাচাই এবং সম্পূর্ণতা পরীক্ষা'}</span>
                      </li>
                      <li className="flex items-start">
                        <svg className="w-4 h-4 sm:w-5 sm:h-5 text-blue-600 mt-0.5 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                        </svg>
                        <span className="text-xs sm:text-sm break-words">{isEnglish ? 'Eligibility assessment' : 'যোগ্যতা মূল্যায়ন'}</span>
                      </li>
                      <li className="flex items-start">
                        <svg className="w-4 h-4 sm:w-5 sm:h-5 text-blue-600 mt-0.5 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                        </svg>
                        <span className="text-xs sm:text-sm break-words">{isEnglish ? 'Case assignment to appropriate department' : 'উপযুক্ত বিভাগে মামলা বরাদ্দ'}</span>
                      </li>
                    </ul>
                  </div>
                  <div>
                    ...
                    <div className="space-y-2 sm:space-y-3">
                      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center p-2 sm:p-3 bg-white dark:bg-slate-700 rounded-lg space-y-1 sm:space-y-0">
                      ...
                      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center p-2 sm:p-3 bg-white dark:bg-slate-700 rounded-lg space-y-1 sm:space-y-0">
                        <span className="text-xs sm:text-sm text-gray-700 dark:text-gray-300">
                          {isEnglish ? 'Complex Cases' : 'জটিল বিসয়ক সময়সীমা'}
                        </span>
                        <span className="text-xs sm:text-sm text-blue-600 dark:text-blue-400 font-medium">
          ...
          <section className="bg-white dark:bg-slate-800 shadow-lg rounded-lg overflow-hidden">
            <div className="bg-gradient-to-r from-amber-600 to-amber-700 px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
              <h2 className="text-lg sm:text-xl lg:text-2xl font-bold text-white flex items-center">
                <svg className="w-5 h-5 sm:w-6 sm:h-6 mr-2 sm:mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                <span className="truncate">{isEnglish ? 'Step 3: Service Delivery' : 'ধাপ ৩: সেবা প্রদান'}</span>
              </h2>
            </div>
            <div className="p-4 sm:p-6 lg:p-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 lg:gap-8">
                ...
                <div className="space-y-4 sm:space-y-6">
                  <div className="flex items-start">
                    <div className="flex-shrink-0 w-10 h-10 sm:w-12 sm:h-12 bg-purple-600 rounded-lg flex items-center justify-center mr-3 sm:mr-4">
                      <svg className="w-5 h-5 sm:w-6 sm:h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                      </svg>
                    </div>
                  ...
                  <div className="flex items-start">
                    <div className="flex-shrink-0 w-10 h-10 sm:w-12 sm:h-12 bg-orange-600 rounded-lg flex items-center justify-center mr-3 sm:mr-4">
                      <svg className="w-5 h-5 sm:w-6 sm:h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                      </svg>
                    </div>
