          ...
          <div className="max-w-2xl mx-auto">
            <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-8">
              <div className="flex items-start">
                <svg className="w-8 h-8 text-red-600 dark:text-red-400 mt-1 mr-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3">
                    ...
                    <Link
                      href={`/${locale}/blog`}
                      className="inline-flex items-center px-4 py-2 border border-gray-300 dark:border-gray-600 text-sm font-medium rounded-md text-gray-700 dark:text-gray-200 bg-white dark:bg-slate-800 hover:bg-gray-50 dark:hover:bg-slate-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500"
                    >
                ...
                <div className="mb-6">
                  ...
                  <div className="flex flex-wrap gap-2 mb-6">
                    {post.tags.map((tag, index) => (
                      <span
                        key={index}
                        className="inline-block px-3 py-1 bg-gray-100 dark:bg-slate-700 text-gray-700 dark:text-gray-300 text-xs font-medium rounded-full"
                      >
                        #{tag}
                      </span>
                    ))}
            ...
            <div className="space-y-8">
                      ...
                      >
                        <div className="flex space-x-3">
                          ...
                          <div className="flex-1 min-w-0">
                            <h4 className="text-sm font-medium text-gray-900 dark:text-white group-hover:text-green-600 transition-colors line-clamp-2">
              ...
              <div className="bg-white dark:bg-slate-800 shadow-lg rounded-lg p-6">
                ...
                <div>
                  <Link
                    href={`/${locale}/blog`}
                    className="inline-block px-4 py-2 bg-green-100 dark:bg-green-900/20 text-green-700 dark:text-green-300 text-sm font-medium rounded-lg hover:bg-green-200 dark:hover:bg-green-900/30 transition-colors"
                  >
                    {getCategoryName(post.category)}
                  </Link>
                </div>
