            ...
            <div className="flex items-center justify-between h-14 sm:h-16">
              ...
              <div className="flex items-center space-x-2 sm:space-x-3 min-w-0 flex-1">
                ...
                <div className="text-sm sm:text-base lg:text-xl font-bold text-slate-800 dark:text-slate-100 truncate">
                  {locale === 'bn' ? 'জাতীয় সংসদ নির্বাচন (২০১৪, ২০১৮ ও ২০২৪) তদন্ত কমিশন' : 'National Elections Inquiry Commission'}
                </div>
              </div>
                  ...
                  if (item.type === 'link') {
                    return (
                      <a 
                        ...
                        className="group relative px-8 py-6 text-gray-700 dark:text-gray-200 hover:text-green-600 dark:hover:text-green-400 font-medium transition-colors duration-200"
                      >
                    ...
                    return (
                      <div key={item.id} className="group relative">
                        <button className="flex items-center px-8 py-6 text-gray-700 dark:text-gray-200 hover:text-green-600 dark:hover:text-green-400 font-medium transition-colors duration-200">
                          {item.label[locale as keyof typeof item.label]}
