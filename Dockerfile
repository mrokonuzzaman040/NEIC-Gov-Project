...
ARG NEXT_PUBLIC_RECAPTCHA_KEY_SECRET
ARG NEXT_PUBLIC_MAX_UPLOAD_FILE_SIZE_MB
ENV NEXT_PUBLIC_RECAPTCHA_KEY=$NEXT_PUBLIC_RECAPTCHA_KEY
ENV NEXT_PUBLIC_RECAPTCHA_KEY_SECRET=$NEXT_PUBLIC_RECAPTCHA_KEY_SECRET
ENV NEXT_PUBLIC_MAX_UPLOAD_FILE_SIZE_MB=$NEXT_PUBLIC_MAX_UPLOAD_FILE_SIZE_MB
RUN npm run build
